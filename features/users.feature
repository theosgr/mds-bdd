Feature: Users Feature
  ...
  Scenario: Create a user with bad format date of birth
    When I create the following "user":
      | lastName | firstName | birthDate | address | phone | email |
      | Diot | Jeremy | 19910812 | 18 Boulevard Albert Einstein | 0652428451 | diot.jeremy@gmail.com |
    Then I should have response "BAD_REQUEST"
    And following error : "Bad format date"

  Scenario: Create a user with bad format email
    When I create the following "user":
      | lastName | firstName | birthDate | address | phone | email |
      | Diot | Jeremy | 1991-08-29 | 18 Boulevard Albert Einstein | 0652428451 | diotjeremy.fr |
    Then I should have response "BAD_REQUEST"
    And following error : "Bad format email"

   Scenario: Create a user with bad format phone
    When I create the following "user":
      | lastName | firstName | birthDate | address | phone | email |
      | Diot | Jeremy | 1991-08-29 | 18 Boulevard Albert Einstein | 1234567891 | diot.jeremy@gmail.com |
    Then I should have response "BAD_REQUEST"
    And following error : "Bad format phone number"
  ...
  Scenario: Update a user with bad format date of birth
    When I update the "user" having id "a2e84855-be23-42fc-81ed-83e807198c9c" with following data:
      | lastName | firstName | birthDate | address | phone | email |
      | Henry | Thierry | 19830123 | 19 boulevard des Anciens | 0712382910 | lemaildethierry@mail.com |
    Then I should have response "BAD_REQUEST"
    And following error : "Bad format date"

  Scenario: Update a user with bad format phone
    When I update the "user" having id "a2e84855-be23-42fc-81ed-83e807198c9c" with following data:
      | lastName | firstName | birthDate | address | phone | email |
      | Henry | Thierry | 1983-01-29 | 19 boulevard des Anciens | 1234567891 | lemaildethierry@mail.com |
    Then I should have response "BAD_REQUEST"
    And following error : "Bad format phone number"

  Scenario: Update a user with bad format email
    When I update the "user" having id "a2e84855-be23-42fc-81ed-83e807198c9c" with following data:
      | lastName | firstName | birthDate | address | phone | email |
      | Henry | Thierry | 1983-01-29 | 19 boulevard des Anciens | 0612902314 | mailincorrect.fr |
    Then I should have response "BAD_REQUEST"
    And following error : "Bad format email"
